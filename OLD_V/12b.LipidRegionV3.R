...
SNPsToEnhM0123.summary2<-SNPsToEnhM0123.summary[SNPsToEnhM0123.summary$chr==chromosome,] %>% 
  unite(labely, SNPS,TRAITAbb, sep=".")


vertical.lines<-SNPsToEnhM0123.summary2[SNPsToEnhM0123.summary2$chr==chromosome,"CHR_POS"]

names(vertical.lines)<-
  SNPsToEnhM0123.summary2[SNPsToEnhM0123.summary2$chr==chromosome,"labely"]
